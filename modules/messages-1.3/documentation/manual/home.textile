...
h2. New in version 1.3

- Configurable default language. If *messages.defaultLanguage* property is defined use messages.[property value] when reading/writing the default language.
- Improved support for custom MessageResource
